...
> Answer: Being able to Navigate Single page apps without refreshing
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Controlled components are being assigned to state and giving them a default value of sorts. 
